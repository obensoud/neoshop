...
(function ($) {
  ...
  var barcode = {
    ...
    digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
      ...
      var columns = digit[0].length;
      var content = "";
      var bar0 = "<div style=\"float: left; font-size: 0px; zoom: 200%; background-color: " + settings.bgColor + "; height: " + mh + "px; width: &Wpx\"></div>";    
      var bar1 = "<div style=\"float: left; font-size: 0px; zoom: 200%; width:0; border-left: &Wpx solid " + settings.color + "; height: " + mh + "px;\"></div>";
