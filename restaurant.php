...
if($_GET['o'] == 'addMenu') { 
// add order
	echo "<div class='div-request div-hide'>addMenu</div>";
} else if($_GET['o'] == 'manBar') { 
	echo "<div class='div-request div-hide'>manBar</div>";
} else if($_GET['o'] == 'manKitchen') { 
	echo "<div class='div-request div-hide'>manKitchen</div>";
} // /else manage order
else if($_GET['o'] == 'manOrderReady') { 
	echo "<div class='div-request div-hide'>manOrderReady</div>";
} // /else manage order
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php } else if($_GET['o'] == 'manBar') { ?>
			<i class="glyphicon glyphicon-glass"></i> Manage Bar
		<?php } else if($_GET['o'] == 'manKitchen') { ?>
			<i class="glyphicon glyphicon-cutlery"></i> Kitchen
		<?php } else if($_GET['o'] == 'manOrderReady') { ?>
			<i class="glyphicon glyphicon-check"></i> Order Ready
		<?php } ?>
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'addMenu') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Numbre of Table</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Numbre of Table" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
...
<script src="custom/js/restaurant.js"></script>
