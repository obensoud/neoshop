...
$sql = "SELECT order_id, order_date, client_name, client_contact, payment_status FROM orders WHERE order_status = 1 and number_of_table IS NOT NULL and number_of_table <> '' ";
