	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-tower"></i> Profil utilisateur</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" data-target="#addProfilModel"> <i class="glyphicon glyphicon-plus-sign"></i> Ajouter un profil </button>
				</div> <!-- /div-action -->				
				
				<table class="table" id="manageProfilUserTable">
					<thead>
						<tr>							
							<th>nom du profil</th>
							<th>Statut</th>
...
<div class="modal fade" id="addProfilModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	
    	<form class="form-horizontal" id="submitProfilUserForm" action="php_action/createProfil.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Ajouter un profil</h4>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="profilName" class="col-sm-3 control-label">Nom du profil: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="profilName" placeholder="Nom du profil" name="profilName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
	        <div class="form-group">
	        	<label for="profilStatus" class="col-sm-3 control-label">Statut: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
    	...
    	<form class="form-horizontal" id="editBrandForm" action="php_action/editProfilUser.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-brand-result">
		      	<div class="form-group">
		        	<label for="editBrandName" class="col-sm-3 control-label">Nom du profil: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editBrandName" placeholder="Nom du profil" name="editBrandName" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
...
<script src="custom/js/profiluser.js"></script>
