	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> <?php echo tr("Category Management")?></div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<table class="table" id="manageCategoriesTable">
					<thead>
						<tr>							
							<th> <?php echo tr("The names of Categorys")?></th>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategories.php" method="POST">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> <?php echo tr("Add a category")?></h4>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="categoriesName" class="col-sm-4 control-label"><?php echo tr("The name of the Category:")?> </label>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" id="createCategoriesBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> <?php echo tr("Save change")?></button>
	      </div> <!-- /modal-footer -->	      
     	</form> <!-- /.form -->	     
    </div> <!-- /modal-content -->    
  </div> <!-- /modal-dailog -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editCategories.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-edit"></i><?php echo tr("Edit the Category")?></h4>
	      </div>
	      <div class="modal-body">
		      ...
		      <div class="edit-categories-result">
		      	<div class="form-group">
		        	<label for="editCategoriesName" class="col-sm-4 control-label"> <?php echo tr("Nam of the category:")?> </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
		        ...
		        <div class="form-group">
		        	<label for="editCategoriesStatus" class="col-sm-4 control-label"><?php echo tr("Status:")?> </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
	      ...
	      <div class="modal-footer editCategoriesFooter">
	        ...
	        <button type="submit" class="btn btn-success" id="editCategoriesBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> <?php echo tr("Save")?> change</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeCategoriesModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> <?php echo tr("Remove the Category")?></h4>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer removeCategoriesFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> <?php echo tr("Close")?></button>
        <button type="button" class="btn btn-primary" id="removeCategoriesBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> <?php echo tr("Save change")?></button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
