...
$(document).ready(function() {
	...
	manageBrandTable = $("#manageBrandTable").DataTable({
		'ajax': 'php_action/fetchOption.php',
		'order': []		
	});
...
function editBrands(brandId = null) {
	if(brandId) {
		...
		$.ajax({
			url: 'php_action/fetchSelectedOptionUser.php',
			type: 'post',
			...
			success:function(response) {
				...
				$('#editBrandName').val(response.option_name);
				// setting the brand status value
				$('#editBrandStatus').val(response.option_active);
				// brand id 
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#removeBrandBtn").unbind('click').bind('click', function() {
					...
					$.ajax({
						url: 'php_action/removeOptionUser.php',
						type: 'post',
						data: {brandId : brandId},
						dataType: 'json',
						success:function(response) {
