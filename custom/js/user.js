...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			var ConfirmYourPassword = $("#ConfirmYourPassword").val();
			...
			if(CollaboratorName == "") {
				$("#CollaboratorName").after('<p class="text-danger">Product Name field is required</p>');
				$('#CollaboratorName').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#CollaboratorName").find('.text-danger').remove();
				// success out for form 
				$("#CollaboratorName").closest('.form-group').addClass('has-success');	  	
			}	// /else
			
			if(Email == "") {
				$("#Email").after('<p class="text-danger">Bar code field is required</p>');
			...
			if(Password == "") {
				$("#Password").after('<p class="text-danger">Quantity field is required</p>');
			...
			if(ConfirmYourPassword == "") {
				$("#ConfirmYourPassword").after('<p class="text-danger">Rate field is required</p>');
				$('#ConfirmYourPassword').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#ConfirmYourPassword").find('.text-danger').remove();
				// success out for form 
				$("#ConfirmYourPassword").closest('.form-group').addClass('has-success');	  	
			}	// /else

			if(Profil == "") {
				$("#Profil").after('<p class="text-danger">Brand Name field is required</p>');
				$('#Profil').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#Profil").find('.text-danger').remove();
				// success out for form 
				$("#Profil").closest('.form-group').addClass('has-success');	  	
			}	// /else

			if(OptionName == "") {
				$("#OptionName").after('<p class="text-danger">Category Name field is required</p>');
				$('#OptionName').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#OptionName").find('.text-danger').remove();
				// success out for form 
				$("#OptionName").closest('.form-group').addClass('has-success');	  	
			}	// /else
			...
			if(productImage && CollaboratorName && Email && Password && ConfirmYourPassword && Profil && OptionName && productStatus) {
				...
				$.ajax({
		          ...
		          manageProductTable.ajax.reload(null, true);
							...
							$(".form-group").removeClass('has-error').removeClass('has-success');
								...
								// shows a error message after operation
	...
	if(productId) {
		...
		$.ajax({
			...
			// alert(response.product_image);
				...
				$("#getProductImage").attr('src', 'stock/'+response.user_image);
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				// user id 
				$(".editProductFooter").append('<input type="hidden" name="productId" id="productId" value="'+response.user_id+'" />');				
				$(".editProductPhotoFooter").append('<input type="hidden" name="productId" id="productId" value="'+response.user_id+'" />');				
				
				// user name
				$("#editProductName").val(response.username);
				// email
				$("#editQuantity").val(response.email);
				// profilname
				$("#editBrandName").val(response.profil_id);
				// option name
				$("#editCategoryName").val(response.option_id);
				// status
				$("#editProductStatus").val(response.user_active);
