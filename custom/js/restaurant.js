...
$(document).ready(function() {
	...
	// top nav bar 
	$("#navRestaurant").addClass('active');

	if(divRequest == 'addMenu')  {
		// add order	
		// top nav child bar 
		$('#topNavAddMenu').addClass('active');	
	...
	} else if(divRequest == 'manBar') {
		// top nav child bar 
		$('#topNavManageBar').addClass('active');

		manageOrderTable = $("#manageOrderTable").DataTable({
			'ajax': 'php_action/fetchRestaurant.php',
			'order': []
		});		
					
	} else if(divRequest == 'manKitchen') {
		// top nav child bar 
		$('#topNavManageKitchen').addClass('active');
	...
	}else if(divRequest == 'manOrderReady') {
		// top nav child bar 
		$('#topNavManageOrderReady').addClass('active');
